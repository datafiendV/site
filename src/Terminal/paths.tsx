...
export const paths = [{
    ...
    'response' : `We are a community of thousands of web users fighting back.\r\nWe can provide aggregate anonymized data from social networks, gated content, and large-scale crawling.\r\nTL;DR - We are Google, and we are no one.`,
